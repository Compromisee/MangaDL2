...
def test_defaults_cover_every_source():
    from mangadl.config import load_config
...
def test_ranks_are_unique_and_ordered():
    from mangadl.config import ranked_ids
...
def test_move_up_and_down():
    from mangadl.config import move, ranked_ids
...
def test_disabling_excludes_from_search_but_keeps_the_entry():
    from mangadl.config import is_enabled, ranked_ids, search_ids, set_enabled
...
def test_search_only_exclusion_keeps_the_source_enabled():
    from mangadl.config import is_enabled, ranked_ids, search_ids, set_search_enabled
...
def test_lock_is_off_by_default():
    from mangadl.passlock import status
...
def test_set_and_verify():
    from mangadl.passlock import set_passcode, status, verify
...
def test_passcode_is_never_stored_in_plaintext(isolated_home):
    from mangadl.passlock import LOCK_PATH, set_passcode
...
def test_short_passcodes_are_rejected():
    from mangadl.passlock import set_passcode

    assert set_passcode("ab")["ok"] is False


def test_change_requires_the_current_passcode():
    from mangadl.passlock import change_passcode, set_passcode, verify
...
def test_disable_requires_the_passcode():
    from mangadl.passlock import disable, set_passcode, status
...
def test_recovery_key_resets_the_passcode():
    from mangadl.passlock import recover, set_passcode, verify
...
def test_recovery_key_is_case_insensitive_and_ignores_spaces():
    from mangadl.passlock import recover, set_passcode
...
def test_throttling_kicks_in_after_repeated_failures():
    from mangadl.passlock import MAX_ATTEMPTS, set_passcode, verify
...
def test_verify_passes_when_lock_is_disabled():
    from mangadl.passlock import verify

    assert verify("anything")["ok"] is True


def test_update_options_without_passcode():
    from mangadl.passlock import set_passcode, status, update_options
...
def test_history_records_and_deduplicates():
    from mangadl.features import add_history, get_history
...
def test_history_suggestions():
    from mangadl.features import add_history, suggest
...
def test_history_clear_and_remove():
    from mangadl.features import add_history, clear_history, get_history, remove_history
...
def test_queue_add_and_order():
    from mangadl.features import queue_add, queue_list, queue_move
...
def test_queue_status_and_next():
    from mangadl.features import queue_add, queue_list, queue_next, queue_update
...
def test_queue_remove_and_clear():
    from mangadl.features import queue_add, queue_clear, queue_list, queue_remove
...
def test_stats_accumulate():
    from mangadl.features import get_stats, record_stat
...
def test_stats_reset():
    from mangadl.features import get_stats, record_stat, reset_stats
...
def test_human_size(value, expected):
    from mangadl.features import human_size
...
def test_human_time(value, expected):
    from mangadl.features import human_time
...
def test_blocked_tags_and_titles():
    from mangadl.features import apply_filters, set_filters
...
def test_dedupe_collapses_cross_source_duplicates():
    from mangadl.features import dedupe
...
def test_collection_lifecycle():
    from mangadl.features import (add_to_collection, delete_collection,
...
def test_export_json_csv_and_markdown(tmp_path):
    ...
    from mangadl.features import export_library
...
def test_import_round_trip(tmp_path):
    from mangadl import library
    from mangadl.features import export_library, import_library
...
def test_snapshot_and_restore():
    from mangadl import library
    from mangadl.features import list_snapshots, restore_snapshot, snapshot
...
def test_library_insights():
    from mangadl import library
    from mangadl.features import library_insights
...
def test_search_all_skips_excluded_sources(monkeypatch):
    ...
    from mangadl.sources import SOURCES, search_all
