...
def isolated_home(monkeypatch):
    ...
    import mangadl.robust as robust
...
def test_browse_all_queries_every_enabled_source(monkeypatch):
    from mangadl.sources import SOURCES, browse_all
...
def test_browse_all_skips_excluded_sources(monkeypatch):
    from mangadl.config import set_enabled
    from mangadl.sources import browse_all
...
def test_retry_eventually_succeeds():
    from mangadl.robust import retry
...
def test_backoff_grows_and_stays_capped():
    from mangadl.robust import backoff_delay
...
def test_circuit_opens_after_the_threshold():
    from mangadl.robust import CircuitBreaker, CircuitOpen
...
def test_circuit_half_opens_then_closes_on_success():
    from mangadl.robust import CircuitBreaker
...
def test_ttl_cache_hits_then_expires():
    from mangadl.robust import TTLCache
...
def test_call_safely_returns_the_fallback():
    from mangadl.robust import call_safely
...
def test_gather_keeps_partial_results():
    from mangadl.robust import gather
...
def test_health_report_shape():
    from mangadl.robust import health_report
