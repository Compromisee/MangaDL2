...
class TrayController:
    ...
    def _build_menu(self):
        ...
        def status_items():
            ...
            yield MenuItem("Open MangaDL", self._on_open, default=True)
            yield MenuItem(
    ...
    def start(self):
        ...
        self._thread = threading.Thread(target=run, name="mangadl-tray",
                                        daemon=True)
        self._thread.start()
    ...
    def _start_refresh_loop(self, interval=2.0):
        ...
        threading.Thread(target=loop, name="mangadl-tray-refresh",
                         daemon=True).start()
